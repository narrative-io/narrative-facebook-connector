locals {
  ...
  stage = "dev"
  vpc_id = "vpc-0b01002ae08b03c74"
  private_subnet_ids = [
    "subnet-068b26e91bae911e3",
    "subnet-02a1dfaeaee745e65",
    "subnet-0c7cbb43f60bb315d",
    "subnet-0a3c1c35dd2f9d52b",
    "subnet-05e227ebd65594acd",
    "subnet-0e3ec0beb1f33ace7"
  ]
}
