...
object FacebookClient extends LazyLogging {
  ...
  //  - 1212393198887712: ad account shared with Narrative by King. We want to filter this out so it doesn't get shown
  //    in demos to clients when using the Facebook token of a Narrative admin as a matter of protecting King's privacy.
  //    https://app.clubhouse.io/narrativeio/story/1872/blacklist-narrative-king-facebook-account-for-destinations
